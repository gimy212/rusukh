                ...
                {{-- Here Jobs Sidebar  --}}
                    <li>
                        ...
                        <div class="collapse" id="sidebarCrm">
                            <ul class="nav-second-level">
                                <li>
                                    <a href="{{route('jobs.index')}}">doctors</a>
                                </li>
                                <li>
                                    <a href="{{route('jobs.create')}}">Add doctors</a>
                                </li>
                ...
                {{-- Sidebar Emergency --}}
                   <li>
                    ...
                    <div class="collapse" id="sidebarCrm">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('Emergency.index')}}">patients</a>
                            </li>
                            <li>
                                <a href="{{route('Emergency.create')}}">Add patients</a>
                            </li>

                        </ul>
                    </div>
                    </li>
                {{-- endSidebar Emergency --}}
                {{-- Here attend_methods  Sidebar  --}}
                    <li>
                     ...
                     <li>
                        <a href="#sidebarCrm" data-toggle="collapse">
                            <i class=" icon-clock"></i>.
                            <span>pharmacy_section</span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="sidebarCrm">
                            <ul class="nav-second-level">
                                <li><a class="slide-item" href="{{ url('/' . $page='Pharmacy_section') }}">section</a></li>
                                <li>
                                    
                                    <a href="{{ url('/' . $page='Pharmacy_section/create') }}">Add section</a>
                                </li>
                    ...
                    <div class="collapse" id="sidebarCrm">
                        <ul class="nav-second-level">
                            <li>
                                ...
                                <a href="{{ url('/' . $page='Pharmacy_product/index') }}">sections</a>
                            </li>
                            <li>
                                
                                <a href="{{ url('/' . $page='Pharmacy_ptoduct/create') }}">Add section</a>
                            </li>
            ...
            {{-- Here attend_methods  Sidebar  --}}
                <li>
                    ...
                    <div class="collapse" id="sidebarCrm">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('lab.index')}}">Device</a>
                            </li>
                            <li>
                                <a href="{{route('lab.create')}}">Add Device</a>
                            </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarCrm">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ url('/' . $page='reports/invoices_reports') }}">result</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarCrm">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('ambulance.index')}}">Devices</a>
                            </li>
                            <li>
                                <a href="{{route('ambulance.create')}}">Add Devices</a>
                            </li>
                ...
                {{-- Here devices  Sidebar  --}}
                    <li>
                        ...
                        <div class="collapse" id="sidebarCrm">
                            <ul class="nav-second-level">
                                <li>
                                    <a href="{{route('devices.index')}}">sections</a>
                                </li>
                                <li>
                                    <a href="{{route('devices.create')}}">Add sections</a>
                                </li>
