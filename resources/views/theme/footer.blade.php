...
<div class="col-6 mb-5">
    <h4 class="text-white mb-4">@lang('home.sections')</h4>
    <ul class="">
      <li class="mb-3 text-light"><a class="text-light d-block" href="https://rusukh.com.sa/category/28">@lang('home.footer_link1')

</a></li>
      <li class="mb-3 text-light"><a class="text-light d-block" href="https://rusukh.com.sa/category/21"> @lang('home.footer_link2')
    </a></li>
      <li class="mb-3 text-light"><a class="text-light d-block" href="https://rusukh.com.sa/post/grease-interceptor">  @lang('home.footer_link3') </a></li>
      <li class="mb-3 text-light"><a class="text-light d-block" href="https://rusukh.com.sa/post/gray-water-treatment2">   @lang('home.footer_link4')</a></li>
      <li class="mb-3 text-light"><a class="text-light d-block" href="https://rusukh.com.sa/category/26">  @lang('home.footer_link5')
</a></li>
              ...
              <!-- contact info -->
              <div class="col-6 mb-5">
                <h4 class="text-white mb-4">@lang('home.footer_contact_us')</h4>
...
<img style="width:180px; height:55px;border-radius: 11px;" alt="View Rusukh Specilaized Company profile on Ariba Discovery" border=0 src="https://service.ariba.com/an/p/Ariba/badge_180x55.jpg">
</a>
              </div>
    ...
    <div class="container-certifcate" >
       <!-- certifcate -->
        ...
        <img src="https://rusukh.com.sa/images/about/logoa2 (3).png" alt="">
                <img src="https://rusukh.com.sa/images/about/marouf.webp" alt="">

        <img src="https://rusukh.com.sa/images/about/ksa2030.webp" alt="">
          <img style="    width: 150px;" src="https://rusukh.com.sa/images/about/saudi.webp" alt="">
    ...
    <div class="whatsnline">
      ...
      <div style="   direction: ltr; text-align: left;" id='whatsapp-chat' class='hide'>
        <div class='header-chat'>
          <div class='head-home'>
            ...
            <p><span style="color: #fff;"  class="whatsapp-name"> @lang('home.rusukh') </span><br><small>@lang('home.reply_within') </small></p>
          ...
          <div pattern="https://elfsight.com/assets/chats/patterns/whatsapp.png" class="WhatsappChat__Component-sc-1wqac52-0 whatsapp-chat-body">
            <div class="WhatsappChat__MessageContainer-sc-1wqac52-1 dAbFpq">
              ...
              <div style="opacity: 1;" class="WhatsappChat__Message-sc-1wqac52-4 kAZgZq">
                <div class="WhatsappChat__Author-sc-1wqac52-3 bMIBDo">@lang('home.rusukh') </div>
                <div class="WhatsappChat__Text-sc-1wqac52-2 iSpIQi">@lang('home.hello')</div>
      ...
      <a class='blantershow-chat' href='javascript:void' title='Show Chat'><svg width="20" viewBox="0 0 24 24"><defs/><path fill="#eceff1" d="M20.5 3.4A12.1 12.1 0 0012 0 12 12 0 001.7 17.8L0 24l6.3-1.7c2.8 1.5 5 1.4 5.8 1.5a12 12 0 008.4-20.3z"/><path fill="#4caf50" d="M12 21.8c-3.1 0-5.2-1.6-5.4-1.6l-3.7 1 1-3.7-.3-.4A9.9 9.9 0 012.1 12a10 10 0 0117-7 9.9 9.9 0 01-7 16.9z"/><path fill="#fafafa" d="M17.5 14.3c-.3 0-1.8-.8-2-.9-.7-.2-.5 0-1.7 1.3-.1.2-.3.2-.6.1s-1.3-.5-2.4-1.5a9 9 0 01-1.7-2c-.3-.6.4-.6 1-1.7l-.1-.5-1-2.2c-.2-.6-.4-.5-.6-.5-.6 0-1 0-1.4.3-1.6 1.8-1.2 3.6.2 5.6 2.7 3.5 4.2 4.2 6.8 5 .7.3 1.4.3 1.9.2.6 0 1.7-.7 2-1.4.3-.7.3-1.3.2-1.4-.1-.2-.3-.3-.6-.4z"/></svg> @lang('home.whatsapp_contact')  </a>
