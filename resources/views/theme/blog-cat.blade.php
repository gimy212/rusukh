...
<!-- page title -->
<section class="section bg-cover overlay" data-background="{{asset('https://rusukh.com.sa/images/about/Top-Klima-3.jpg')}}">
    <div class="container">
      <div class="row">
        <div class="col-12">
    ...
    <div class="container">
      <div class="row">
          ...
          <article class="card border-0 rounded-0 position-relative box-shadow zindex-1">
            ...
            <div class="card-body">
              <div class="title-border-left">
                ...
                <h4 class="card-title"><ahref="{{ route('single.show' , ['slug'=>$item->slug])}}" class="text-dark">
                    @if (App::getLocale()== 'en')
                    {{$item->title}}
                    @else
                    {{$item->title_ar}}
        ...
        @endforeach
              ...
              {!! $blogPosts->links('cpanal.paginate') !!}
