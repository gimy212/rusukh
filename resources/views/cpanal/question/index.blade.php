                  ...
                  <div class="table-responsive">
                      <table id="example" class="table key-buttons text-md-nowrap">
                          ...
                          <tr>
                            ...
                            <th class="border-bottom-0">name_company</th>
                        ...
                        @endphp
                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                <a  style="margin-right: 5px;" class="btn btn-primary btn-rounded btn-fw" target="_blank" href="{{ url('/question_show' , $item->id)}}">Show</a>
                               </td>
                               <td>
                                <a class="btn btn-danger btn-rounded btn-fw" style="margin-right: 5px" onclick="return confirm('are you sure delate this')" href="{{url('/question_delete',$item->id)}}">delete</a>
                              </td>
                            </tr>
                                @endforeach
                              </tbody>
