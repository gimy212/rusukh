      ...
      <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <a href="{{ route('cat.create') }}" type="submit"  class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale">Add Category</a>
                <div class="card-body">
                      ...
                      <table id="example" class="table key-buttons text-md-nowrap">
                        ...
                        @endphp
                            ...
                            <tr>
                               ...
                               <td>
                                    <a  style="margin-right: 5px;" class="btn btn-primary btn-rounded btn-fw" target="_blank" href="{{ route('cat.show' , ['id'=>$item->id])}}">Show</a>
                               </td>
                               <td>
                                    <a style="margin-right: 5px;" href="{{ route('cat.edit' ,['id'=> $item->id] ) }}" type="submit" class="btn btn-info btn-rounded btn-fw">Edit</a>
                               </td>
                               <td>
