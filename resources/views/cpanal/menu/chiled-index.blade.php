              ...
              <div class="col-xl-12">
                  <div class="card mg-b-20">
                      <div class="card-header pb-0">
                          ...
                          <p class="tx-12 tx-gray-500 mb-2">Menus Chiledren </p>
                      </div>
                
                <a href="{{ route('chiled.create') }}" type="submit"  class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale">Add New Menu Chiled</a>
                <div class="card-body">
                      ...
                      <table id="example" class="table key-buttons text-md-nowrap">
                        ...
                        @endphp
                            ...
                            <tr>
                              ...
                              <td>
                                    <a style="margin-right: 5px;" href="{{ url('/chiled_edit' , $item->id ) }}" type="submit" class="btn btn-info btn-rounded btn-fw">Edit</a>
                               </td>
                               <td>
                                    <form action="{{ route('chiled.destroy',['id'=> $item->id])}}" method="POST">
