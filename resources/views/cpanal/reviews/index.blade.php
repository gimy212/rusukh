      ...
      <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <a href="{{ route('reviews.create') }}" type="submit"  class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale">Add New Review</a>
                <div class="card-body">
                        ...
                        @endphp
                            ...
                            <tr>
                               ...
                               <td>
                                    ...
                                    <a style="margin-right: 5px;" href="{{ route('reviews.edit' ,['id'=> $item->id] ) }}" type="submit" class="btn btn-info btn-rounded btn-fw">Edit</a>
                               </td>
                               <td>
