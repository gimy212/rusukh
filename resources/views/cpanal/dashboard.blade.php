    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <a href="{{ route('slider.create') }}" type="submit"  class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale">Create New Slider</a>
                <div class="card-body">
                      ...
                      <table id="example" class="table key-buttons text-md-nowrap">
                        ...
                        @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="margin-right: 5px;" href="{{ route('slider.edit' , ['id'=> $slider->id]) }}" type="submit" class="btn btn-info btn-rounded btn-fw">Edit</a>
                                </td>
                                <td>
                                    <form action="{{ route('slider.destroy', ['id'=>$slider->id] )}}" method="POST">
                                        <button  style="margin-right: 5px" onclick="return confirm('are you sure delate this')" type="submit" class="btn btn-danger btn-rounded btn-fw">Delete</button>
                                   @csrf
                                   @method('DELETE')
                                    </form>
                                </td>
