            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form  method="POST" action="{{ route('password.email') }}" class="pt-3">
                    ...
                    <input type="email" id="exampleInputEmail1" placeholder="Admin Email" class="form-control form-control-lg  @error('email') is-invalid @enderror" name="email" value=" {{ old('email') }}"
